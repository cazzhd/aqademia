...
\usepackage{fancyhdr}
	...
	\cfoot{\thepage}
\usepackage{titlesec}
	\titleformat{\chapter}[block]{\normalfont\bfseries\Huge}{Módulo \thechapter:\\}{.5em}{}[]
	\titleformat{\section}[block]{\normalfont\bfseries\huge}{Sesión\ \thesection:}{.5em}{}[]
	\titleformat{\subsection}[block]{\normalfont\bfseries\Large}{\S\ \thesubsection:}{.5em}{}[]
	\titleformat{\subsubsection}[block]{\normalfont\bfseries\large}{\thesubsubsection:}{.5em}{}[]
...
\usepackage{listings}
	...
	\lstdefinestyle{customc}{basicstyle = \color{listing-text-color}\linespread{1.0}\small\ttfamily{},
...
\titleformat{\chapter}[block]{\normalfont\bfseries\Huge}{Appendix\ \MakeUppercase{\alph{chapter}}:}{.5em}{}[]
